                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="review-content-section">
                             <center><h2>CETAK KARTU UTS</h2></center>
                            <br>
                                @foreach($data as $dt)
                                <table class="table table-hover table-responsive-sm">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" readonly value="{{$TglUTSMulai}} - {{$TglUTSSelesai}}" style="font-size: 10pt;"> </td>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="form-group data-custon-pick data-custom-mg" id="data_5">
                             <a href="{{url('uts_cetak')}}"> <button type="submit" class="btn btn-success" style="float: right;">Cetak</button> </a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" style="border: 1px solid #ddd; border-collapse: collapse;">
                                        ...
                                        @foreach ($data2 as $dt) 
                                            ...
                                            <tr  style="border: 1px solid #ddd;">
                                                ...
                                                <td>{{$dt->MKKode}}</td>
                                                <td>{{$dt->Nama}}</td>
                                                <td>{{$dt->nama_hari}} ({{$dt->UTSTanggal}})</span></td>
                                                <td>{{$dt->UTSRuangID}}</td>
                                                <td>{{$dt->nama_dosen}}</td>

...
<div class="container">
  ...
  <tbody >
          ...
          <tr>
            <th height="19" style="font-size: 20px;" >Kartu Ujian Akhir Semester</th>
            <th width="0"></th>
          </tr>
        </tbody>
  </table>
...
<table width="523"  style="border: 1px solid black;" border="1px">
    <tbody>
      ...
      <tr style="border-bottom: 1px black;" >
            ...
            <span style="font-size: 12px;">({{$dt-> UASTanggal}})</span></td>
            ...
            <td style="text-align:center;font-size:12px; ">{{$dt->UASJamMulai}}</td>
            <td style="text-align:center;font-size:12px; ">{{$dt->UASRuangID}}</td>
            <td style="text-align:center;font-size:12px; "></td>
      </tr>
      @endforeach
      <tr>
      	<td colspan="7"><p style="text-align:center; font-weight:bold">KARTU UAS INI HARUS DITUNJUKKAN KEPADA PENGAWAS PADA SAAT UJIAN</p></td>
      </tr>
